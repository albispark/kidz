<div class="row px-0 mx-md-0 mx-3">
    <div class="col-md-1 col-0"></div>
      ...
      <h2 class="text-left text-md-center p-0 mt-4 mb-md-4 mb-1">Notifiche da leggere</h2>

        <section class="mt-0 mb-3 mx-0 justify-content-center">
          <ul class="text-left my-2 mx-0 list-unstyled">
            <?php foreach($templateParams["notificheUnread"] as $notif):?>
            <!-- NOTIFICA 1 -->
            <li class="border p-2">
        ...
        <h2 class="text-left text-md-center p-0 mt-4 mb-md-4 mb-1">Storico notifiche</h2>
